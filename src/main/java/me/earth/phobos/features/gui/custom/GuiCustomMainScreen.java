...
public class GuiCustomMainScreen
    ...
    public void initGui() {
        ...
        this.buttonList.add(new TextButton(0, this.x, this.y + 20, "NoBitches?"));
        this.buttonList.add(new TextButton(1, this.x, this.y + 44, "AllTheBitches?"));
        this.buttonList.add(new TextButton(2, this.x, this.y + 66, "ConfigIssue?"));
    ...
    public void mouseClicked(int mouseX, int mouseY, int mouseButton) {
        if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("NoBitches?") / 2, this.y + 20, Phobos.textManager.getStringWidth("NoBitches?"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
            this.mc.displayGuiScreen(new GuiWorldSelection(this));
        } else if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("AllTheBitches?") / 2, this.y + 44, Phobos.textManager.getStringWidth("AllTheBitches?"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
            this.mc.displayGuiScreen(new GuiMultiplayer(this));
        } else if (GuiCustomMainScreen.isHovered(this.x - Phobos.textManager.getStringWidth("ConfigIssue?") / 2, this.y + 66, Phobos.textManager.getStringWidth("ConfigIssue?"), Phobos.textManager.getFontHeight(), mouseX, mouseY)) {
